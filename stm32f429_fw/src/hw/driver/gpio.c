...
{
  {GPIOC, GPIO_PIN_11, _DEF_INPUT_PULLUP,  _DEF_HIGH, _DEF_HIGH},  // 0. SDCARD_CD
  {GPIOC, GPIO_PIN_8,  _DEF_INPUT_PULLUP,  _DEF_HIGH, _DEF_HIGH},  //
  {GPIOC, GPIO_PIN_9,  _DEF_INPUT_PULLUP,  _DEF_HIGH, _DEF_HIGH},  //
  {GPIOC, GPIO_PIN_10, _DEF_INPUT_PULLUP,  _DEF_HIGH, _DEF_HIGH},  //
  {GPIOD, GPIO_PIN_2,  _DEF_INPUT_PULLUP,  _DEF_HIGH, _DEF_HIGH},  //
  {GPIOC, GPIO_PIN_12, _DEF_INPUT_PULLUP,  _DEF_HIGH, _DEF_HIGH},  //
};
